...
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (11015, 3560, 'Kenny', 'bird', '2012-02-23' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (11025, 3560, null, 'bird', '2012-02-01' );
 insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (11028, 3560, null, 'bird', '2015-10-01' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (11029, 3560, null, 'bird', '2015-10-01' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (12035, 3560, 'Mr Peanut', 'bird', '1995-02-28' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (12038, 3560, 'Gutsy', 'porcupine', '2012-04-29' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (15001, 3561, 'Big Mike', 'turtle', '2010-02-02' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (15002, 5699, 'George', 'turtle', '1998-02-02' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (15165,  411, 'Burgess', 'dog', '2005-11-20' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (15401,  411, 'Pinkie', 'lizard', '2010-03-15' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (16002, 3423, 'Fritz', 'porcupine', '2015-05-25' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (16003, 1825, 'Ursula', 'cat', '2013-02-06' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (16043, 1825, 'Ursula', 'dog', '2014-06-06' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (16044, 1825, 'Triton', 'dog', '2014-06-06' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (17002, 5699, 'Fritzchen', 'porcupine', '2012-06-02' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (17025, 3561, '25', 'lizard', '2013-01-10' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (17026, 7152, '3P#_26', 'lizard', '2010-01-10' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (17027, 7152, '3P#_25', 'lizard', '2010-01-10' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (19845, 6426, 'Pinkie', 'dog', '2009-02-02' ) ;
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21001,  411, 'Yoggie', 'hedgehog', '2009-05-22' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21002, 1825, 'Edger', 'hedgehog', '2002-10-02' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21003, 6426, 'Calvin Coolidge', 'dog', '2014-06-18' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21004, 3561, 'Gutsy', 'snake', '2011-05-12' );   
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21005, 3423, 'Koshka', 'dormouse', '2011-03-06' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values(21006, 3423, 'Koshka', 'hamster', '2011-06-06' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21007, 1852, 'Pop 22', 'snake', '2010-06-12' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21205, 5689, 'Manfried', 'dog', '2015-03-30' ); 
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21305, 4087, 'Spot', 'dog', '2014-07-27' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21306, 4087, 'Shadow', 'dog', '2014-07-27' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21307, 4087, 'Buddy', 'dog', '2014-07-27' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21314, 4087, 'Adalwine', 'cat', '2013-06-11' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21315, 4534, 'Baldric', 'cat', '2013-06-11' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21316, 5698, 'Etta', 'cat', '2010-06-11' );  
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values (21317, 5698, 'Manfried', 'cat', '2011-06-11' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
  values(21318, 5698, 'Waldrom', 'cat', '2012-06-11' );
insert into vt_animals ( an_id, cl_id, an_name, an_type, an_dob)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2289, 21320, 38,  '2015-04-11 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (2289, 1, 523, 75.00, 'Routine exam' );
	

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2290, 21320, 38,  '2015-04-11 17:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2300, 21316, 38,  '2015-05-08 09:15'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (2300, 1, 108, 75.00, 'Routine exam' );
	

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2352, 10002, 38,  '2015-05-12 09:15'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2389, 21006, 38,  '2015-05-20 09:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (2400, 12038, 38,  '2015-06-02 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (2400, 1, 461, 275.00, 'Aggressive behaviour' );
	

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3002, 11028, 38,  '2015-10-02 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3002, 1, 106, 60.00, 'Initial exam' );
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3003, 11029, 38,  '2015-10-02 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3003, 1, 106, 60.00, 'Initial exam' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4243, 16002, 38,  '2015-06-08 15:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (4243, 1, 461, 275.00, 'Aggressive behaviour' );
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4255, 16002, 38,  '2015-07-08 15:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (4255, 1, 461, 275.00, 'Aggressive behaviour' );
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4612, 21317, 15,  '2015-07-23 08:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4514, 15002, 29,  '2015-08-10 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4203, 16002, 29,   '2015-08-03 14:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (4203, 1, 524, 20.00, 'Follow-up on parasites');    

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4282, 21001, 15,  '2015-08-23 10:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4233, 16002, 29,   '2015-09-03 14:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (4233, 1, 524, 20.00, 'Follow-up on parasites');    
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3105, 17002, 29,  '2015-10-10 9:15'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3010, 17026, 29,  '2015-10-22 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3001, 17027, 29,  '2015-10-24 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3001, 1, 104, 25.00, 'Routine exam');    
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3202, 17025, 29,  '2015-10-03 14:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3202, 1, 341, 20.00, 'Follow-up on parasites');
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3513, 15401, 15,  '2015-11-06 10:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3552, 16003, 15,  '2015-11-10 10:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3304, 17027, 15,  '2015-11-06 10:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3306, 17025, 29,  '2015-11-06 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3390, 19845, 15,  '2015-11-22 09:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3411, 17025, 29,  '2015-12-29 14:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3411, 1, 341, 20.00, 'Follow-up on parasites');

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3412, 17025, 29,  '2015-12-30 14:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3412, 1, 341, 20.00, 'Follow-up on parasites');

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3413, 16003, 15,  '2015-12-01 16:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3413, 1, 308, 5.00, 'Follow-up checkup');

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3612, 16003, 15,  '2015-12-23 08:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3392, 21003, 15,  '2015-12-26 09:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3393, 16002, 29,  '2015-12-23 12:15'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3409, 17027, 29,  '2015-12-27 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3409, 1, 104, 25.00, 'Routine exam');
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3486, 21005, 15,  '2015-12-31 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3486, 1, 461, 275.00, 'Aggressive behaviour' );
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4101, 15001, 15,  '2016-01-02 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4102, 15002, 15,  '2016-01-08 13:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (4102,  1, 104, 60.00, 'Regular exam' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4103, 16002, 38,  '2016-01-08 15:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (4103, 1, 461, 275.00, 'Aggressive behaviour' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3104, 12035, 38,  '2016-01-09 16:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3325, 17026, 29,  '2016-01-15 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3420, 16003, 15,  '2016-01-01 16:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3288, 15001, 25,  '2016-01-31 09:00'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3322, 16002, 29,  '2016-02-10 9:15'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3322, 1, 748, 29.50, 'Rat ulcer recurrence');

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3321, 16002, 29,  '2016-02-17 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3321, 1, 748, 0.00, 'Rat ulcer recurrence');

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3324, 17025, 29,  '2016-02-25 10:45'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3323, 16002, 29,  '2016-02-25 14:30'    );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 

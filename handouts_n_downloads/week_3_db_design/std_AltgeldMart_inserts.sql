-- demo tables for standard sql populate tables
 -- Remove the comment marks to clean up previous table contents 
/* 
delete from  oe_orderDetails;
delete from  oe_orderHeaders;
delete from  oe_shippingModes;

delete from  cust_customers;

delete from  prd_products;
delete from  prd_categories;

delete from  emp_employees;
delete from  emp_jobs;
delete from  emp_departments;
delete from  emp_locations;
*/
...
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values (145, 'Oliver',  'Russ',   '125786901', 100,   80, '2001-03-30',  59000, 004);

insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (150, 'Harold',  'Tuck',   '125689901', 145,   80, '2001-10-28',  20000, 008);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (155, 'Helen',   'Hiller', '120845901', 145,   80, '2004-03-05',  29000, 008);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (201, 'Daniel',  'Harts',  '789012345', 100,   20, '2004-08-25',  15000, 002);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (101, 'Karen',   'Koch',   '112345678', 100,   30, '2008-06-17',  98005, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (205, 'Pat',     'Higgs',  '258712345', 101,   30, '2008-06-01',  75000, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values (102, 'Helen',   'D''Haa', '187008412', 100,  215, '2010-06-12',  60300, 064);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (203, 'Bob',     'Mays',   '145678412', 101,   30, '2010-06-30',  64450, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (103, 'Maria',   'Hunol',  '154658970', 102,  210, '2010-08-01',  69000, 064);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (162, 'Stratus', 'Holme',  '128585289', 101,   35, '2011-03-17',  98000, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (146, 'Rene',    'Partne', '243456543', 100,  215, '2011-03-29',  88954, 064);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (160, 'Robert',  'Dorna',  '354567415', 146,  215, '2011-06-15',  65000, 032);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (161, 'Robert',  'Dewal',  '454567415', 146,  215, '2011-06-15', 120000, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (200, 'Cumulus', 'Whale',  '648772345', 101,   35, '2011-06-17',  65000, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (207, 'Russel',  'Russ',   '115487758', 145,   35, '2011-06-17',  30000, 008);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (108, 'Oliver',  'Green',  '119012345', 101,   30, '2012-12-31',  62000, 016);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (109, 'Robert',  'Fiet',   '854567415', 108,   30, '2012-12-31',  65000, 032);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (110, 'Helen',   'Chen',   '217008412', 108,   30, '2012-12-31',  60300, 032);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (206, 'Rene',    'Geitz',  '541456543', 205,   30, '2013-06-15',  88954, 032);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (204, 'Robert',  'King',   '554167415', 205,   30, '2013-06-15',  99090, 032);
insert into emp_employees(emp_id, name_first, name_last,  ssn, emp_mng, dept_id, hire_date, salary, job_id) 
values  (104, 'Oliver',  'Ernst',  '125876901', 103,  210, '2015-01-25',  65000, 032);
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 540, '2015-06-02', 'DIRECT', 404950, 'FEDEX1', 1, 145);
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 390,   '2015-06-04', 'DIRECT', 403000, 'FEDEX1', 9,  155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 390, 1, 1010,   175.00,  8);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 395,   '2015-06-04', 'DIRECT', 403000, 'FEDEX1', 9,  155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 395, 1, 1010,   195.00, 15);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 301,   '2015-06-04', 'DIRECT', 401250, 'FEDEX2', 9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 301, 1, 1100,   205.00,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 302,   '2015-06-04', 'DIRECT', 404000, 'USPS1', 2,  150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 303,   '2015-06-10', 'DIRECT', 404100, 'USPS1', 2,  155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 303, 1, 1000,   125.00,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 306,  '2015-06-04', 'DIRECT', 903000, 'USPS1', 9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
 ...
 insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 307,  '2015-06-04', 'DIRECT', 900300, 'USPS1', 9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 312,  '2015-06-07', 'DIRECT', 903000, 'USPS1', 5,  145);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 313,  '2015-06-07', 'DIRECT', 903000, 'USPS1', 5,  155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 313, 1, 1000,   125.00, 1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 324,  '2015-06-11', 'DIRECT', 409030, 'UPSGR',  9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 324, 1, 4576,    29.95, 20);
 
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 378,  '2015-06-14', 'DIRECT', 400300, 'USPS1', 9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 411,  '2015-08-01', 'DIRECT', 404950, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 412,  '2015-08-01', 'DIRECT', 403000, 'UPSGR', 1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 412, 2, 1130,   149.99,  1); 


insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 413,  '2015-08-07','ONLINE', 409150, 'USPS1', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 414,  '2015-08-20','ONLINE', 409150, 'UPSEXP', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 414, 1, 1020,    12.95,  13);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 415,  '2015-08-23','ONLINE', 409150, 'UPSEXP', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 550,  '2015-08-02','DIRECT', 903000, NULL, 3, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 551,  '2015-08-03','DIRECT', 903000, NULL, 3, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 551, 1, 1010,   175.00, 20);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 552,  '2015-08-12', 'DIRECT', 401250, 'FEDEX1', 2, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 605,  '2015-09-05', 'DIRECT', 404100, 'UPSGR',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 606,  '2015-09-07', 'DIRECT', 409160, 'FEDEX1',  1, 207);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 606, 1, 1152,    55.00, 1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 607,  '2015-09-15', 'DIRECT', 409160, 'FEDEX1',  1, 207);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 607, 1, 1070,    22.25, 10);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 608,  '2015-09-26', 'DIRECT', 403000, 'UPSGR',  1, 207);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 609,  '2015-09-27', 'DIRECT', 900300, 'USPS1',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 610,  '2015-09-27', 'DIRECT', 903000, 'UPSGR',  1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 610, 1, 4577,    29.95, 2);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 611,  '2015-09-30', 'DIRECT', 403000, 'USPS2',  1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 611, 1, 1080,    25.00, 12);


insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 105,  '2015-10-01', 'DIRECT', 403000, 'UPSGR',  1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 106,  '2015-10-01', 'DIRECT', 401250, 'FEDEX1', 2, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 106,1 , 1060,   255.95,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 107,  '2015-10-02', 'ONLINE', 403050, 'USPS1', 2, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 107, 1, 1110,    49.99,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 108,   '2015-10-02', 'ONLINE', 403000, 'USPS1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 108, 1, 1080,    22.50,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 109,   '2015-10-12', 'DIRECT', 403000, 'UPSGR',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 109, 1, 1130,   149.99,  1);
       
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 110,   '2015-10-12', 'DIRECT', 404950, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 400,  '2015-10-15', 'ONLINE', 403100, 'USPS1', 2, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 401, '2015-10-15', 'ONLINE', 403100, 'USPS1', 2, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 402, '2015-10-18', 'ONLINE', 403100, 'USPS1', 2, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 405, '2015-11-19', 'DIRECT', 408770, 'FEDEX1', 1, 145);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 407, '2015-11-15', 'DIRECT', 403100, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 408, '2015-11-20', 'DIRECT', 404950, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 408, 1, 1071,    15.00,  1);
     
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 111, '2015-11-01', 'DIRECT', 403000, 'UPSGR', 1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 112, '2015-11-08', 'DIRECT', 401890, 'USPS1',  2, 145);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 112, 1, 1110,    49.99,  2);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 113, '2015-11-08', 'ONLINE', 401250, 'FEDEX2', 2, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 113, 1, 1080,    22.50,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 114, '2015-11-08', 'DIRECT', 402100, 'USPS1',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 114, 1, 1130,   125.00,  5);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 115,  '2015-11-08', 'ONLINE', 402100, 'USPS2',  1, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 116, '2015-11-12', 'ONLINE', 405000, NULL,  9, 155);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 117, '2015-11-28', 'ONLINE', 402100, NULL,  9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 118, '2015-11-28', 'DIRECT', 403010, NULL,  3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 118, 1, 1125,   475.00,  4);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 119, '2015-11-28','DIRECT', 401250, NULL, 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 123, '2015-12-05','ONLINE', 409150, 'USPS1', 3, 155);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 124, '2015-12-07','DIRECT', 409160, 'FEDEX1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 124, 1, 1151,    14.99,  1);
       
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 125, '2015-12-09','DIRECT', 409160, 'FEDEX1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 125, 1, 1152,    55.00,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 126,  '2015-12-15','DIRECT', 409190, 'FEDEX1', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 126, 1, 1100,    49.99, 1);
       
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 127,  '2015-12-15','ONLINE', 915001, 'USPS1', 4, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 128,  '2015-12-15','ONLINE', 409030, 'FEDEX1', 4, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 128, 1, 1060,   255.95,  2);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 129,  '2015-12-15','DIRECT', 915001, 'FEDEX1', 7, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 129, 1, 1141,    99.99,  3);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 130, '2015-12-30','ONLINE', 409030, 'USPS2', 7, 145);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2503, '2016-01-04', 'DIRECT', 404100, 'USPS1', 2,  155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 2503, 1, 1130,   149.99,  1);
       
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2504, '2016-01-11', 'DIRECT', 404100, 'UPSGR',  9, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 2504, 1, 1130,   149.99,  1);
       
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2505, '2016-01-12', 'DIRECT', 403000, 'UPSGR',  1, 145);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2506, '2016-01-12', 'DIRECT', 401250, 'UPSEXP', 2, 150);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2120, '2016-01-02','DIRECT', 903000, NULL, 3, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 2120, 1, 1010,   175.00, 10);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2121, '2016-01-03','DIRECT', 903000, NULL, 3, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2122, '2016-01-23','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders(order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2507, '2016-02-01', 'ONLINE', 403050, 'USPS1', 2, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 2507, 2, 1090,   145.99,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2805, '2016-01-05', 'DIRECT', 404100, 'UPSGR',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2806, '2016-01-07', 'DIRECT', 409160, 'FEDEX1',  1, 207);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 2806, 1, 1152,    55.00, 1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2807, '2016-01-15', 'DIRECT', 409160, 'FEDEX1',  1, 207);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 2807, 1, 1070,    22.25, 10);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3808, '2016-01-26', 'DIRECT', 403000, 'UPSGR',  1, 207);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3809, '2016-01-27', 'DIRECT', 900300, 'USPS1',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 3809, 1, 1080,    25.00, 5);


insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3810, '2016-01-27', 'DIRECT', 903000, 'UPSGR',  1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 3810, 1, 4577,    29.95, 2);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2811, '2016-01-31', 'DIRECT', 403000, 'UPSEXP',  1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2508, '2016-02-01', 'ONLINE', 403000, 'USPS1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2509, '2016-02-12', 'DIRECT', 403000, 'UPSGR',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 4510, '2016-02-01', 'DIRECT', 404950, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 4511, '2016-02-01', 'DIRECT', 403000, 'UPSGR', 1, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3515, '2016-02-02','ONLINE', 409150, 'USPS1', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 3515, 1, 1110,    49.99,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3516, '2016-02-02','ONLINE', 409150, 'USPS1', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 3516, 1, 1020,    12.95,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3518, '2016-02-03','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2218, '2016-03-08','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 223,  '2016-03-05','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 4224, '2016-03-07','DIRECT', 409160, 'FEDEX1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 2225, '2016-03-09','DIRECT', 409160, 'FEDEX1', 3, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 3227,  '2016-03-01', 'ONLINE', 403050, 'USPS1', 2, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 519,  '2016-04-04','ONLINE', 401890, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
 ...
 insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 520,  '2016-04-04','ONLINE', 404900, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 522,  '2015-04-05','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 522, 1, 1080,    22.50, 2);

 insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 715,  '2016-04-05','ONLINE', 409150, 'USPS1', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 716,  '2016-04-06','ONLINE', 409150, 'USPS1', 3, 150);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 716, 1, 1020,    12.95,  1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 718,  '2016-04-08','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 523,  '2016-04-05','ONLINE', 409150, 'USPS1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
       values ( 523, 1, 1130,   149.99, 1);

insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 524,  '2016-04-07','DIRECT', 409160, 'FEDEX1', 3, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 525,  '2016-05-09','DIRECT', 409160, 'FEDEX1', 3, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 527,  '2016-05-01', 'ONLINE', 403050, 'USPS1', 2, null);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 528,  '2016-05-01', 'ONLINE', 403000, 'USPS1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 529,  '2016-05-12', 'DIRECT', 403000, 'UPSEXP',  1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
 ...
 insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 535,  '2016-05-12', 'DIRECT', 404950, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
...
insert into oe_orderHeaders (order_id, order_date, order_mode, customer_id, shipping_mode_id, order_status, sales_rep_id)
       values ( 536,  '2016-05-12', 'DIRECT', 403000, 'FEDEX1', 1, 155);
insert into oe_orderDetails (order_id, line_item_id, prod_id, quoted_price, quantity_ordered)
